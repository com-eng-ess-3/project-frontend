    ...
    return (
      <Card className={classes.cardContainer}>
        <Box justifyContent='center' display='flex'>
            <Typography variant="h5" className={classes.topicText}>{isMyProfile? 'My Profile' : 'Profile'}</Typography>
        </Box>
            ...
            <Box  width='60%' marginLeft='15px'>
                ...
                <Paper width='100%' className={classes.paper}>
                    ...
                    {isMyProfile ? 
                      <Box>
                        {(inNameEditState) ? 
                          <SaveIcon className={classes.saveEditButton}
                            onClick={() => setNameEditState(false)}
                          /> 
                        :
                          <BuildIcon className={classes.saveEditButton}
        ...
        <Typography variant="h6" className={classes.topicText}>Follower : 25,435</Typography>
        <Typography variant="h6" className={classes.topicText}>Interested in :</Typography>
        <Paper width='100%' className={classes.interestPaper}>
              <Box width='100%'>
                {(inInterestEditState) ? 
                  ...
                  />
                :
                  <Typography variant="h6" className={classes.content}>HEE !</Typography>
                }
              </Box>
              {isMyProfile ? 
                <Box marginTop='5px'>
